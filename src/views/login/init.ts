export default function initLoginBg() {
  ...
  let canvas = document.getElementById("canvas") as HTMLCanvasElement,
    ...
    count = 0,
    maxStars = 1500//星星数量
  const canvas2 = document.createElement("canvas"), ctx2 = canvas2.getContext("2d") as CanvasRenderingContext2D
  canvas2.width = 100
  canvas2.height = 100
  const half = canvas2.width / 2, gradient2 = ctx2.createRadialGradient(half, half, 0, half, half, half)
